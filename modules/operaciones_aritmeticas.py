...
class OperacionesAritmeticas:
    ...
    @staticmethod
    def desnormalizar_imagen(imagen_normalizada):
        """
        Convierte una imagen normalizada [0,1] de vuelta al rango [0,255].
        
        Args:
            imagen_normalizada: Imagen normalizada en rango [0,1]
            
        Returns:
            Imagen en rango [0,255]
        """
        return (imagen_normalizada * 255.0).astype(np.uint8)