...
class OperacionesGeometricas:
    ...
    @staticmethod
    def redimensionar_224x224(imagen):
        """
        Redimensiona una imagen específicamente a 224x224 píxeles.
        Útil para modelos de CNN preentrenados.
        
        Args:
            imagen: Imagen de entrada
            
        Returns:
            Imagen redimensionada a 224x224
        """
        return cv2.resize(imagen, (224, 224), interpolation=cv2.INTER_AREA)
